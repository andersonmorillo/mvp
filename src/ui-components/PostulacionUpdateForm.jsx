...
export default function PostulacionUpdateForm(props) {
  const {
    id: idProp,
    postulacion,
    onSuccess,
  ...
  const resetStateValues = () => {
    const cleanValues = postulacionRecord
      ? { ...initialValues, ...postulacionRecord }
      : initialValues;
  ...
  const [postulacionRecord, setPostulacionRecord] = React.useState(postulacion);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Postulacion, idProp)
        : postulacion;
      setPostulacionRecord(record);
    };
    queryData();
  }, [idProp, postulacion]);
  React.useEffect(resetStateValues, [postulacionRecord]);
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Postulacion.copyOf(postulacionRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "PostulacionUpdateForm")}
      {...rest}
    >
      <TextField
        label="Nombre"
