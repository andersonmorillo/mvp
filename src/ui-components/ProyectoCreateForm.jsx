...
export default function ProyectoCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setEstudiante(initialValues.estudiante);
    setProfesor(initialValues.profesor);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Proyecto(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ProyectoCreateForm")}
      {...rest}
    >
      <TextField
        label="Nombre"
